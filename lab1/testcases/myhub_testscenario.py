...
def test_hub():
    ...
    # my test case : a frame with any unicast address except one assigned to hub
    # interface should be sent out all ports except ingress
    reqpkt = new_packet(
        "11:51:14:11:45:14",
        "19:19:81:01:91:19",
    ...
    s.expect(
        ...
        ("An Ethernet frame from 11:51:14:11:45:14 to 19:19:81:01:91:19 "
         "should arrive on eth1")
    )
    s.expect(
        PacketOutputEvent("eth0", reqpkt, "eth2", reqpkt, display=Ethernet),
        ("Ethernet frame destined for 19:19:81:01:91:19 should be flooded out"
         " eth0 and eth2")
    )
    ...
    s.expect(
        PacketInputEvent("eth1", resppkt, display=Ethernet),
        ("An Ethernet frame from 19:19:81:01:91:19 to 11:51:14:11:45:14 "
         "should arrive on eth1")
    )
    s.expect(
        PacketOutputEvent("eth0", resppkt, "eth2", resppkt, display=Ethernet),
        ("Ethernet frame destined to 11:51:14:11:45:14 should be flooded out"
         "eth0 and eth2")
    )
    return s
